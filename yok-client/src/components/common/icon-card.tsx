...
const IconCard: React.FC<Props> = ({
	...
	return (
		<Link
			href={href}
			className={cn(
				"group flex flex-col justify-center items-center rounded-lg",
				{
					...
					"gap-[15px] xl:gap-[20px] 2xl:gap-[30px] 3xl:gap-[35px] px-3 lg:px-4 py-5 lg:py-8 bg-gray-200":
						variant === "list",
				}
			)}
		>
			<div
				className={cn("relative flex flex-col items-center w-fit", {
