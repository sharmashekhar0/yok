...
const Widgets: React.FC<WidgetsProps> = ({ widgets, variant }) => {
	return (
		<Container>
			<div
				className={cn(
					"grid grid-cols-2 text-justify md:grid-cols-3 lg:grid-cols-4 gap-5 md:gap-1 xl:gap-10  pb-9 md:pb-14 lg:pb-16 2xl:pb-20 3xl:pb-24 lg:mb-0.5 2xl:mb-0 3xl:-mb-1",
					{
